...
return {
    ...
    config = function()
        ...
        local function on_attach(bufnr)
            ...
            vim.keymap.set('n', '<Leader>tf', api.tree.toggle_no_bookmark_filter,  opts('Toggle Filter: No Bookmark'))
            vim.keymap.set("n", "<Leader>tb", api.marks.toggle, opts("Toggle Bookmark"))
